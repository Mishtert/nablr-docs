...
<Card title="ForensicsIQ" icon="search">
...
<Tip>Paste the error message, stack trace, or log snippet directly into the prompt. ForensicsIQ uses concrete evidence, not guesses.</Tip>
