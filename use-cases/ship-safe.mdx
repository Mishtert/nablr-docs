...
<Card title="Tollgate" icon="shield-check">
...
<Warning>Tollgate is a blocking gate, not a linter. A failing check means no merge until resolved or explicitly deferred with documented rationale.</Warning>
